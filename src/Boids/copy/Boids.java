...
public class Boids {
	...
	public void ajouter_proie(Boids proie) {
		this.proies = proie;
	}
	
	public void ajouter_predateur(Boids predateurs) {
	...
	public void etat_suivant() {
		...
		for (Boid boid: tab_aux) {
			boid.move(this, proies, predateurs, height, width);
		}
