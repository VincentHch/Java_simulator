...
public class TestSimulator {
	...
	public static void main(String[] args) {
		...
		simulator.addBoids(1000, 20, 2, 2.62, 1, Color.RED, "o"); //Les élèves
		/**simulator.addBoids(100, 30, 5, 2, 3, Color.GREEN, "{}"); //Les profs
		
		
		simulator.boidsGroups[0].ajouter_predateur(simulator.boidsGroups[1]);
		simulator.boidsGroups[1].ajouter_proie(simulator.boidsGroups[0]);
		*/
